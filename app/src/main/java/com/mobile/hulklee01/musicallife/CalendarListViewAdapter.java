...
public class CalendarListViewAdapter extends ArrayAdapter {

    int resourceId;
    private ArrayList<CalendarListViewItem> calendarList = new ArrayList<CalendarListViewItem>();

    public CalendarListViewAdapter(Context context,int resource, ArrayList<CalendarListViewItem> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.activity_calendar_listviewitem, parent, false);
        }
